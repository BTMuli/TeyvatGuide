...
mod tests {
  ...
  fn missing_cache_dirs_are_empty() {
    ...
    assert_eq!(summary.chunk_protected_bytes, 0);
    assert_eq!(summary.chunk_protected_count, 0);
    assert_eq!(summary.sdk_bytes, 0);
    assert_eq!(summary.sdk_count, 0);
    assert_eq!(summary.sdk_protected_bytes, 0);
    assert_eq!(summary.sdk_protected_count, 0);
  ...
  fn counts_chunk_and_sdk_files() {
    ...
    assert_eq!(summary.reclaimable_bytes, 9);
  }
  ...
  fn clear_removes_unreferenced_files_and_keeps_protected() {
    ...
    assert_eq!(summary.chunk_count, 1);
    assert_eq!(summary.sdk_count, 0);
    assert_eq!(summary.chunk_protected_bytes, 5);
    assert_eq!(summary.chunk_protected_count, 1);
    assert_eq!(summary.reclaimable_bytes, 0);
