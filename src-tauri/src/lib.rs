...
use crate::game::commands::{
  game_install_cancel, game_install_draft_cancel, game_install_draft_create,
  ...
  game_package_cache_status, game_package_cancel, game_package_plan, game_package_recover,
  game_package_snapshot, game_package_start, game_package_switch, game_package_switch_plan,
  game_package_task_cleanup, game_package_task_list, game_package_verify,
